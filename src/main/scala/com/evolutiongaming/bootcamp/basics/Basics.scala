...
import com.evolutiongaming.bootcamp.basics.CoolArray.b
...
object Basics {
  ...
  def helloMethod(name: String): String = s"Hello, ${name.toString()}!"
  ...
  val helloFunction: String => String = (name: String) => /* implement here */ s"Hello, $name!"
  ...
  val stringLength: String => Int = (s: String) => /* implement here */ s.size
